...
# export SLACK_API_TOKEN=xoxb-498580303680-2366316234864-2lVdA4tHYFVV3MAEH6ecJ5nK
...
# var = "[    {        \"mrkdwn_in\": [\"text\"],        # default color if deployment_color is not defined        \"color\": \"#FF0000\",        \"pretext\": \"_Deployment created for_ *luis.git* _ref:_ `head/master` \",        \"author_name\": \"luisesillo\",         \"author_link\": \"http://flickr.com/bobby/\",        \"author_icon\": \"https://placeimg.com/16/16/people\",        \"title\": \"\",        # \"title_link\": \"https://api.slack.com/\",        \"text\": \":information_source: *_~Github Action has been cancelled~_* :information_source:\",        \"fields\": [            {                \"title\": \"Cloud Run deploy URL\",                \"value\": \"<vergaaa|Link to cloud run>\",                \"short\": True            },            {                \"title\": \"Actions URL\",                \"value\": \"<http/mi/url/luis.git/commit/7as87y786asd/checks|Github action: epaaaaa_colombia>\",                \"short\": True            },            {                \"title\": \"Commit\",                \"value\": \"<http/mi/url/luis.git/commit/7as87y786asd|Commit>\",                \"short\": True            },            {                \"title\": \"Cloud run deployment\",                \"value\": \"PLEASE CHECK URL\",                \"short\": True            }        ],        # \"thumb_url\": \"http://placekitten.com/g/200/200\",        \"footer\": \"Created by DevOps | Infra Team\",        \"footer_icon\": \" https://platform.slack-edge.com/img/default_application_icon.png\",    }]"
   
# print(var.replace('\r','').replace('\n','').replace('\t','').replace(" ", ""))

# print(j2_template.render(caca=caca))


# print(message_attachments)
# template = Template('Hello {{ caca }}!')

# # # template = Template('Hello {{ name }}!')
# print(message_attachments.render(caca=caca))
